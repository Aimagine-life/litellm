...
use litellm_core::ocr::handler::{OcrProviderRequest, send_ocr_request};
    ...
    Observer::Error: std::fmt::Display,
{
    ...
    let provider_request = OcrProviderRequest {
    ...
    let response = send_ocr_request(request_builder, provider_request, observer).await?;
